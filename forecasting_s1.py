...
model1=pickle.load(open('C:/Users/ASUS/1A sharan/Forecast_arima.pkl',"rb"))
data1=pd.read_csv('C:/Users/ASUS/1A sharan/CO2_forecast_data_10years.csv')
data2=pd.read_csv("C:/Users/ASUS/1A sharan/CO2.csv")
